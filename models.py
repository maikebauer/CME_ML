...
class CNN3D(nn.Module):
    ...
    def forward(self, input_img):
        ...
        x_1, indices_1 = F.max_pool3d(x_11, kernel_size=2, stride=2, return_indices=True)
        # Encoder Stage - 3
        dim_2 = x_1.size()
        x_20 = F.relu(self.encoder_conv_20(x_1))
        x_21 = F.relu(self.encoder_conv_21(x_20))
        x_22 = F.relu(self.encoder_conv_22(x_21))
        x_2, indices_2 = F.max_pool3d(x_22, kernel_size=[2,2,2], stride=2, return_indices=True)
        # Encoder Stage - 4
        dim_3 = x_2.size()
        x_30 = F.relu(self.encoder_conv_30(x_2))
        x_31 = F.relu(self.encoder_conv_31(x_30))
        x_32 = F.relu(self.encoder_conv_32(x_31))
        x_3, indices_3 = F.max_pool3d(x_32, kernel_size=[2,2,2], stride=2, return_indices=True)
        ...
        x_4, indices_4 = F.max_pool3d(x_42, kernel_size=[1,2,2], stride=2, return_indices=True)
        
        # Decoder


        # Decoder Stage - 5
        x_4d = F.max_unpool3d(x_4, indices_4, kernel_size=[1,2,2], stride=2, output_size=dim_4)
        ...
        # Decoder Stage - 4
        x_3d = F.max_unpool3d(x_40d, indices_3, kernel_size=[2,2,2], stride=2, output_size=dim_3)
        ...
        # Decoder Stage - 3
        x_2d = F.max_unpool3d(x_30d, indices_2, kernel_size=[2,2,2], stride=2, output_size=dim_2)
        ...
        # Decoder Stage - 2
        x_1d = F.max_unpool3d(x_20d, indices_1, kernel_size=2, stride=2, output_size=dim_1)
        ...
        # Decoder Stage - 1
        x_0d = F.max_unpool3d(x_10d, indices_0, kernel_size=2, stride=2, output_size=dim_0)
